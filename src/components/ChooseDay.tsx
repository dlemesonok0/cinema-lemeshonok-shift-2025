    ...
    return (
        <div
            ...
            {schedules.map((item, index) => {
                ...
                return (
                    <div key={index} className={`cursor-pointer py-2.5 px-4 ${isSelected ? 'bg-white dark:bg-darkbg' : ''} rounded-2xl border-lightSecondary dark:border-darkSecondary border-2`} onClick={() => handleDateSelect(item)}>
